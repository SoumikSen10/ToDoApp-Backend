...
public class BasicAuthenticationSecurityConfiguration 
{
    ...
    */
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception
	{
		...
		//also enable access to preflight request
		return http.authorizeHttpRequests(
				auth -> auth.requestMatchers(HttpMethod.OPTIONS,"/**").permitAll().anyRequest().authenticated()).httpBasic(Customizer.withDefaults()).sessionManagement(
